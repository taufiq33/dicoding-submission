...
window.addEventListener("load", function(){
    // ngecek browser mendukung localStorage atau tidak
    if (typeof(Storage) !== "undefined"){
        ...
        console.warn("Browser tidak mendukung local storage");
    }
})
...
function checkSessionUserAnswerField(){
